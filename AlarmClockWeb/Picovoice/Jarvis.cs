...
namespace AlarmClockPi
{
    ...
    {        
        ...
        string porcupineModelPath = @"/Apps/AlarmClock/AlarmClockWeb/bin/Debug/net8.0/linux-arm64/lib/common/porcupine_params.pv";
        string rhinoModelPath = @"/Apps/AlarmClock/AlarmClockWeb/bin/Debug/net8.0/linux-arm64/lib/common/rhino_params.pv";
        ...
        public Jarvis(ILogger<Jarvis> Log, IConfiguration config)
        {
            ...
            if (cs != null)
            {
                ...
                porcupineModelPath = cs.GetValue<string>("porcupineModelPath", @"/Apps/AlarmClock/AlarmClockWeb/bin/Debug/net8.0/linux-arm64/lib/common/porcupine_params.pv");
                rhinoModelPath = cs.GetValue<string>("rhinoModelPath", @"/Apps/AlarmClock/AlarmClockWeb/bin/Debug/net8.0/linux-arm64/lib/common/rhino_params.pv");

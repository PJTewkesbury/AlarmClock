    ...
    public class Jarvis : IDisposable
    {
        ...
        public Jarvis(ILogger<Jarvis> Log, IConfiguration config)
        {
            ...
            if (cs != null)
            {
                ...
                contextPath = cs.GetValue("IntentFile", @"/Apps/AlarmClock/Picovoice/AlarmClock_en_raspberry-pi_v3_0_0.rhn");

                porcupineModelPath = cs.GetValue("porcupineModelPath", @"/Apps/AlarmClock/Picovoice/porcupine_params.pv");
                rhinoModelPath = cs.GetValue("rhinoModelPath", @"/Apps/AlarmClock/Picovoice/rhino_params.pv");
                wakeWordPath1 = cs.GetValue("wakeWordPath1", "/Apps/AlarmClock/Picovoice/jarvis_raspberry-pi.ppn");
                wakeWordPath2 = cs.GetValue("wakeWordPath2", "/Apps/AlarmClock/Picovoice/alexa_raspberry-pi.ppn");

...
namespace AlarmClock.Voice
{
    ...
    public class Rhino : IDisposable
    {
        ...
        private nint _libraryPointer = nint.Zero;
        ...
        [DllImport(LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        private static extern void pv_rhino_delete(nint handle);
        ...
        [DllImport(LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        private static extern RhinoStatus pv_rhino_reset(nint handle);

        [DllImport(LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        private static extern RhinoStatus pv_rhino_context_info(
            nint handle,
            out nint contextInfo);

        [DllImport(LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        private static extern nint pv_rhino_version();
        ...
        [DllImport(LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        private static extern RhinoStatus pv_get_error_stack(out nint messageStack, out int messageStackDepth);

        [DllImport(LIBRARY, CallingConvention = CallingConvention.Cdecl)]
        private static extern void pv_free_error_stack(nint messageStack);
            ...
            bool requireEndpoint = true)
        {
            ...
            nint accessKeyPtr = Utils.GetPtrFromUtf8String(accessKey);
            nint modelPathPtr = Utils.GetPtrFromUtf8String(modelPath);
            nint contextPathPtr = Utils.GetPtrFromUtf8String(contextPath);
        ...
        public Inference GetInference()
        {
            ...
            if (isUnderstood)
            {
                nint intentPtr, slotKeysPtr, slotValuesPtr;
                int numSlots;
                ...
                int elementSize = Marshal.SizeOf(typeof(nint));
        ...
        public void Dispose()
        {
            if (_libraryPointer != nint.Zero)
            {
                pv_rhino_delete(_libraryPointer);
                _libraryPointer = nint.Zero;

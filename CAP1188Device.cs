...
namespace AlarmClockPi
{
    ...
    public class CAP1188Device
    {
        ...
        public byte touched()
        {
            ...
            _write_register(_CAP1188_MAIN_CONTROL, (byte)(current & ~((byte)0x01)));
        ...
        public byte thresholds
        {
            get
            {
                var data = this.threshold_values();
                if (data != null)
                    return data[0];
                else
                    return 255;
            ...
            set
            {
                ...
                Span<byte> d = data;
                d.Fill(value);
                this._write_block(_CAP1188_THESHOLD_1, d.ToArray());
            }
        }

        public virtual byte[] threshold_values()
        {
            return this._read_block(_CAP1188_THESHOLD_1, 8);
        }
        ...
        public int delta_count(int pin)
        {
            ...
            int raw_value = (int)_read_register(_CAP1188_DELTA_COUNT[pin - 1]); // return 0-> 255 which means -127 -> 127, bit 7 = sign bit
